...
export const metadata: Metadata = {
  title: "About | Kana TV",
  description:
    "Learn about Kana TV's mission, values, and creative approach to Ethiopian entertainment.",
};
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 text-white/80 leading-relaxed max-w-3xl">
              ...
              entertainment meets culture and community.
            </p>
          </div>
      ...
      <section className="px-6 sm:px-10 lg:px-16 pb-16">
        <div className="rounded-2xl border border-white/10 bg-gradient-to-r from-pink-700/20 via-black to-black p-8">
          ...
          <p className="mt-2 text-white/80 max-w-3xl">
            ...
            meaningful partnerships that create impact.
          </p>
          <a
            href="/contact"
