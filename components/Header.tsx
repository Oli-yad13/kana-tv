...
export default function Header() {
  ...
  return (
    ...
    >
        ...
        <div className="flex h-20 items-center justify-center relative">
          ...
          <nav className="hidden md:flex items-center space-x-16">
            {NAVIGATION_ITEMS.map((item) => (
              <button
                key={item.name}
                className="relative group text-sm md:text-base lg:text-lg font-bold text-black tracking-wide uppercase"
              >
                {item.name}
          ...
          <div className="absolute right-0">
            <a
              ...
              className="text-sm font-medium text-black/70 hover:text-black transition-colors tracking-wide uppercase"
            >
              YouTube
            </a>
          </div>
            ...
            >
              <div className="flex flex-col space-y-4">
                {NAVIGATION_ITEMS.map((item) => (
                  <button
                    key={item.name}
                    className="relative group text-lg font-bold text-black tracking-wide uppercase text-left"
      ...
      {/* Dotted line at bottom of header - full width */}
